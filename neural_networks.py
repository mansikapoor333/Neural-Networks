...
class linear_layer:
    ...
    def forward(self, X):
        ...
        ################################################################################
        forward_output1 = X.dot(self.params['W'])
        forward_output = forward_output1 + self.params['b']
        ...
        if hasattr(module, 'params'):
            for key, _ in module.params.items():
                ...
                if _alpha > 0.0:
                    ...
                    mom=momentum[module_name + '_' + key]
                    mom = _alpha * mom - _learning_rate * g
                    module.params[key] += mom
